    ...
    <Form {...form}>
      ...
      >
        ...
        <div className="flex flex-col justify-center items-start gap-8 self-stretch p-6 rounded-[32px] border border-[#0E464F] bg-[#08252B]">
          ...
          <section className="flex h-[200px] max-md:h-[243px] max-md:p-[16px_24px] max-md:justify-between flex-col items-center gap-2 self-stretch p-6 rounded-[24px] border-r-[2px] border-b-[2px] border-l-[2px] border-[#07373F] bg-[rgba(10,12,17,0.10)] bg-[radial-gradient(57.42%_106.59%_at_14.02%_32.06%,rgba(36,160,181,0.2)_0%,rgba(36,160,181,0)_100%)] backdrop-blur-[7px]">
          ...
          <div className="flex flex-col gap-[32px] w-full">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-[8px] w-full">
                  ...
                  <div className="flex flex-col w-full justify-center items-center gap-4  p-4 rounded-[24px] border border-[#07373F] bg-[#052228]">
                    <FormControl>
                      <RadioGroup
                        ...
                        {ticketType.map((type) => (
                          ...
                          >
                            ...
                            <div
                              ...
                              className={`flex w-[158px] max-md:w-full h-[110px] flex-col items-start gap-3 p-3 rounded-[12px] border border-[#197686] ${
              ...
              render={({ field }) => (
                <FormItem className="space-y-[8px]">
                  ...
                  >
                    ...
                    <SelectContent className="bg-[#052228] text-white text-[18px]">
                      {Array.from({ length: 3 }, (_, i) =>
                        ...
                        <SelectItem
                          key={num}
                          value={num}
                          className="px-4 py-2 text-[18px] focus:bg-[#12464E] focus:text-white"
                        >
                          {num}
                        </SelectItem>
                      ))}
            ...
            <div className="flex max-md:hidden font-nanum-myeongjo max-md:flex-col items-start gap-4 flex-[1_0_0]">
              <Button
                ...
                className="flex bg-[#03232a] max-md:w-full transition-colors duration-200 hover:bg-[#0a181b] max-md:py-[12px] text-[#24A0B5] py-6 justify-center items-center gap-2 flex-1 rounded-md border border-[#24A0B5]"
              >
                Cancel
              </Button>
              <Button className="hover:bg-[#3c98a8] max-md:w-full transition-colors duration-200 flex px-6 py-6 max-md:py-[12px] justify-center items-center gap-2 flex-1 rounded-md bg-[#24A0B5]">
                Next
              </Button>
            </div>
